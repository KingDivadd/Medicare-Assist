...
const CreateCarrierFeeModal = ({menuRoleList, menuRoleModal, selectedMenuRole, setMenuRoleList, setMenuRoleModal, setSelectedMenuRole }:MenuRoleModalProps) => {
    ...
    const [dropElements, setDropElements] = useState({
        planFeeLink: 'SELECT', description: '', procedure: '', cpt: '', descriptionII: '', fee: 0, expected: 0, allowed: 0, changeDate: '20/05/2024'
    })
                    ...
                    <div className="h-auto w-[80%] mx-auto shadow-xl">
                        ...
                        <div onClick={(e) => e.stopPropagation()} className="w-full flex flex-col items-end justify-start gap-3 h-auto bg-white  py-[15px] pb-[20px] rounded-b-[5px] ">
                            <span className="w-[98%] mx-auto flex flex-row items-end justify-start px-5 border-b-[6px] gap-2 border-sky-600 mt-3 ">
                                ...
                                <button type="button" onClick={()=>{handleClickedBtn('modifier')}} className={clickedBtn === 'modifier'? 'active-payment-btn': 'payment-btn'}>Modifier</button>
                            </span>  
                            ...
                            <div className="w-[100%] mx-auto flex flex-row justify-end px-[50px] items-start gap-[50px] ">
                                <div className="w-[70%] mx-auto flex flex-col justify-start items-center gap-5 ">
                                    ...
                                    <span className="w-full mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                                        <span className="flex w-full flex-row items-start justify-between gap-5">
                                            ...
                                            <span className="flex-1  flex flex-row items-center justify-between ">
                                                <textarea onChange={handleChange} value={dropElements.description} rows={2} name="description" id="description" placeholder='' className='flex-1 flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 py-1 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px] resize-none '  ></textarea>
                                            </span>
                                        </span>
                                    </span>
                                    ...
                                    <span className="w-full mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                                        <span className="flex w-full h-[28px] flex-row items-center justify-between gap-5">
                                            <p className="text-sm text-slate-700 text-end w-[30%] ">Procedure</p>
                                            <span className="flex-1 h-[28px] gap-3 flex flex-row items-center justify-between ">
                                                <input onChange={handleChange} value={dropElements.procedure} type="text" name="procedure" id="procedure" placeholder='' className='w-[40%] flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                                                <span className="w-[60%] gap-3 h-full flex flex-row items-center justify-end">
                                                    <p className='text-sm text-slate-700 text-end w-[120px]' >CPT</p>
                                                    <input onChange={handleChange} value={dropElements.cpt} type="text" name="cpt" id="cpt" placeholder='' className='w-full flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                                                </span>
                                            </span>
                                        </span>
                                    </span>
                                    ...
                                    <span className="w-full mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                                        <span className="flex w-full flex-row items-start justify-between gap-5">
                                            <p className="text-sm text-slate-700 text-end w-[30%] ">Description</p>
                                            <span className="flex-1  flex flex-row items-center justify-between ">
                                                <textarea onChange={handleChange} value={dropElements.descriptionII} rows={2} name="descriptionII" id="descriptionII" placeholder='' className='flex-1 flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 py-1 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px] resize-none '  ></textarea>
                                            </span>
                                        </span>
                                    </span>
                                    ...
                                    <span className="w-full mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                                        <span className="flex w-full h-[28px] flex-row items-center justify-between gap-5">
                                            ...
                                            <span className="flex-1 h-[28px] gap-3 flex flex-row items-center justify-between ">
                                                <input onChange={handleChange} value={dropElements.fee} type="text" name="fee" id="fee" placeholder='' className='w-[40%] flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                                                <span className="w-[60%] gap-3 h-full flex flex-row items-center justify-end">
                                                    <p className='text-sm text-slate-700 text-end w-[120px]' >Expected</p>
                                                    <input onChange={handleChange} value={dropElements.expected} type="text" name="expected" id="expected" placeholder='' className='w-full flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                                                </span>
                                            </span>
                                        </span>
                                    </span>
                                    ...
                                    <span className="w-full mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                                        <span className="flex w-full h-[28px] flex-row items-center justify-between gap-5">
                                            <p className="text-sm text-slate-700 text-end w-[30%] ">Allowed</p>
                                            <span className="flex-1 h-[28px] gap-3 flex flex-row items-center justify-between ">
                                                <input onChange={handleChange} value={dropElements.allowed} type="text" name="allowed" id="allowed" placeholder='' className='w-[40%] flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                                                <span className="w-[60%] gap-3 h-full flex flex-row items-center justify-end ">
                                                    <p className='text-sm text-slate-700 text-end w-[120px]' >Change Date</p>
                                                    <input onChange={handleChange} value={dropElements.changeDate} type="text" name="changeDate" id="changeDate" placeholder='' className='w-full flex h-full items-center justify-center text-slate-700 text-sm border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                                                </span>
                                            </span>
                                        </span>
                                    </span>

                                    <span className="w-full mx-auto flex flex-row items-start justify-center gap-5 mt-2 h-auto mt-3 ">
                                        <button className="w-[150px] rounded-[3px] bg-lime-500 hover:bg-lime-600 text-white text-sm h-[35px] ">Create Carrier Fee</button>
...
export default CreateCarrierFeeModal