...
const PlanPage = () => {
    ...
    const [dropElements, setDropElements] = useState({
        plan: '',  description: '', category: '', planFeeLink: '', payerID: '', active: false, inactive: false, all: false
        ...
        <div className="w-[90%] flex flex-col gap-3 items-center justify-start pt-[15px] ">
            <span className="w-[70%] mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
                    <p className="text-sm text-slate-700 text-end w-[100px]">Plan</p>
                    <input onChange={handleChange} value={dropElements.plan}  type="text" name="plan" id="plan" placeholder='' className='w-[250px] flex h-full items-center justify-center text-slate-500 text-sm font-semibold border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                </span>
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
            ...
            <span className="w-[70%] mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
                    ...
                    <input onChange={handleChange} value={dropElements.planFeeLink}  type="text" name="planFeeLink" id="planFeeLink" placeholder='' className='w-[250px] flex h-full items-center justify-center text-slate-500 text-sm font-semibold border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                </span>
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
                    <p className="text-sm text-slate-700 text-end w-[100px]">Payer Id</p>
                    <input onChange={handleChange} value={dropElements.payerID}  type="text" name="description" id="payerID" placeholder='' className='w-[250px] flex h-full items-center justify-center text-slate-500 text-sm font-semibold border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                </span>
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
                    {/*  */}
                    <p className="w-[5px]"></p>
            ...
            <div className="w-[110%] flex flex-col items-center justify-start border border-sky-600 rounded-[5px] bg-white mt-[10px]">
                <span className="h-[40px] w-full flex items-center justify-between px-2 bg-sky-600 rounded-t-[5px] border border-sky-600 ">
                    <p className="text-sm text-white text-start font-semibold ">Insurance Carriers</p>

                    <span className="w-auto h-[30px] flex flex-row items-start justify-center gap-2 ">
                        <button onClick={handleCreateCpt} className="px-2 h-full rounded-[3px] flex justify-center items-center bg-white hover:bg-slate-100 text-sm text-slate-700">Create Insurance Carriers</button>
                            ...
                            {[1,2,3,4,5,6,7,8,9,0,1,2,3,4,5].map((data, ind)=>{
                                return (
                                    <span key={ind} className="w-full h-[35px] hover:bg-gray-100 flex flex-row items-center justify-between">
                                        <p className="text-sm  text-sky-700 px-2 w-[10%] ">AARP MED</p>
                                        <p className="text-sm text-slate-700 px-2 w-[20%] ">AETNA SENIOR SUPPLEMENT</p>
                                        <p className="text-sm text-slate-700 px-3 w-[10%] ">09023</p>
                                        <p className="text-sm text-slate-700 px-3 w-[10%] ">COMM</p>
                                        <p className="text-sm text-slate-700 px-3 w-[10%] ">OTHER</p>
                                        <p className="text-sm text-slate-700 px-3 w-[20%] "></p>
                                        <p className="text-sm text-slate-700 px-4 w-[20%] ">30</p>
                                    </span> 
                                )
                            })}
                        </span>
