...
import CreateFUDenialCodesModal from '../createDenialCodesModal'

const DenialCodePage = () => {
        ...
        <div className="w-[90%] flex flex-col gap-3 items-center justify-start pt-[15px] ">
            <span className="w-[70%] mx-auto flex flex-row items-center justify-center gap-[10px] h-auto">
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
                    <p className="text-sm text-slate-700 text-end w-[120px]">835/277 Code</p>
                    <input onChange={handleChange} value={dropElements.code}  type="text" name="code" id="code" placeholder='' className='w-[300px] flex h-full items-center justify-center text-slate-500 text-sm font-semibold border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                </span>
                <span className="flex w-[50%] h-[28px] flex-row items-center justify-between gap-5">
                    <p className="text-sm text-slate-700 text-end w-[120px]">Followup Reason</p>
                    <input onChange={handleChange} value={dropElements.followupReason}  type="text" name="followupReason" id="followupReason" placeholder='' className='w-[300px] flex h-full items-center justify-center text-slate-500 text-sm font-semibold border border-slate-500 px-2 bg-white focus:bg-gray-100 focus:outline-none rounded-[3px]' />
                </span>
            </span>
            ...
            <div className="w-[110%] flex flex-col items-center justify-start border border-sky-600 rounded-[5px] bg-white mt-[10px]">
                ...
                <div className="w-full flex flex-col items-center justify-start min-h-[20px] border border-sky-600 border-t-0 ">
                    <span className="w-full h-[35px] bg-blue-100 flex flex-row items-center justify-between">
                        <p className="text-sm font-semibold text-slate-700 px-2 w-[23%] ">835/277 Code</p>
                        <p className="text-sm font-semibold text-slate-700 px-2 w-[23%] ">Remark Code 1</p>
                        <p className="text-sm font-semibold text-slate-700 px-2 w-[23%] ">Remark Code 2</p>
                        <p className="text-sm font-semibold text-slate-700 px-2 w-[31%] ">Followup Reason</p>
                    </span>
                            ...
                            {[1,2,3,4,5,6,7,8,9,0,1,2,3,4,5].map((data, ind)=>{
                                return (
                                    <span key={ind} className="w-full h-[35px] hover:bg-gray-100 flex flex-row items-center justify-between">
                                        <p className="text-sm text-slate-700 px-2 w-[23%] "></p>
                                        <p className="text-sm text-slate-700 pl-3 pr-2 w-[23%] "></p>
                                        <p className="text-sm text-slate-700 pl-3 pr-2 w-[23%] "></p>
                                        <p className="text-sm text-slate-700 pl-4 pr-2 w-[31%] "></p>
                                    </span> 
                                )
                            })}
                        </span>
            ...
            {menuRoleModal && <CreateFUDenialCodesModal menuRoleList={menuRoleList} setMenuRoleList={setMenuRoleList} menuRoleModal={menuRoleModal} setMenuRoleModal={setMenuRoleModal} selectedMenuRole={selecteMenuRole} setSelectedMenuRole={setSelecteMenuRole} />}
        </div>
    )
}

export default DenialCodePage