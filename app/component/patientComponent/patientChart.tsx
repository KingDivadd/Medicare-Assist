                ...
                <div className="flex w-full bg-gray-200 cont-2 overflow-y-auto px-5">
                    <div className="w-full h-auto flex-col">
                        ...
                        <span className="w-full flex flex-row items-center justify-between gap-3 h-[50px] px-4">
                            <p className="text-xl text-sky-700 font-semibold h-full flex items-end">Patient Chart</p>
                        ...
                        <div className="w-full flex flex-row gap-4 mt-[30px]">
                            ...
                            <div className="lg:w-[60%] flex flex-row rounded-[5px] bg-white ">
                                <span className="relative w-[250px] h-[300px] border-r border-slate-300 flex items-center justify-center">
                                    ...
                                    <div className=" absolute left right-[15px] flex flex-col w-5 justify-center items-center h-full w-auto">
                        ...
                        <div className="w-full flex flex-row justify-between gap-1 mt-3">
                            <span className="h-full w-2 flex items-center justify-center my-auto "><FaCaretLeft size={35} className='text-blue-800' /> </span>

                            <div className="flex-1 flex flex-col bg-blue-200 rounded-b-[5px] rounded-t-[5px]">
                                <span className="flex items-center justify-between px-3 rounded-t-[5px] bg-blue-200 h-[45px]">
                                    <p className="text-xl text-slate-600 font-semibold">VISIT</p>
                                    <span className="flex flex-row items-center justify-end gap-2">
                                        <button type="button" className='text-[14px] text-slate-200 bg-amber-500 hover:bg-amber-600 h-[30px] my-auto px-3 flex flex-row items-center justify-center rounded-[3px]'>
                                ...
                                <div className="w-full flex-1 flex items-center justify-center p-2 pt-0">
                                    <div className="w-full flex items-center justify-center bg-sky-900 h-full rounded-[5px] py-3">
                                        <div className="flex flex-col h-full gap-1">
                                            <p className="text-slate-200 text-[16px] font-semibold w-full flex items-center justify-center">SAT 06/04/2024</p>
                                            <p className="text-slate-200 text-[16px] font-semibold w-full flex items-center justify-center">CHIEF COMPLAINT</p>
                                            ...
                                            <p className="text-slate-200 text-[16px] font-semibold w-full flex items-center justify-center">SIGNED OFF/BILLED</p>
                                            <p className="text-slate-200 text-[16px] font-semibold w-full flex items-center justify-center">BALDRICH</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <span className="h-full w-2 flex items-center justify-center my-auto "><FaCaretRight size={35} className='text-blue-800' /> </span>
                        </div>
                        ...
                        <div className="w-full flex flex-row gap-3 items-start justify-between gap-3 mt-3 ">
                            <div className="w-[65%] h-full flex flex-col gap-3">
                                <div className="h-full flex flex-col w-full bg-white rounded-[5px]">
                                    <span className="flex flex-row items-center justify-start rounded-t-[5px] w-full bg-blue-200 h-[45px] border-2 border-blue-200 px-3">
                                        <p className="text-lg text-slate-600 font-semibold">APPOINTMENTS</p>
                                    </span>
                                    <div className="w-full flex items-center jusitify-center px-2 py-2">
                                        <span className="flex flex-row items-center justify-start w-full rounded-[3px] h-[40px] bg-amber-100 px-2">
                                            <p className="text-[17px] text-slate-700">06/04/2024 9:30:00 AM - CXRAY, BALDRICH, SCHEDULED</p>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="w-full flex items-center jusitify-center px-2 py-2 bg-white">
                                    <span className="flex flex-row items-center justify-start w-full rounded-[3px] h-[40px] ">
                                        <p className="text-[17px] text-slate-800 font-bold w-1/5 flex items-center justify-center bg-amber-100 h-[37px]"> Scheduled - 1 </p>
                                        <p className="text-[17px] text-slate-800 font-bold w-1/5 flex items-center justify-center bg-green-400 h-[37px] "> Seen - 0 </p>
                                        <p className="text-[17px] text-slate-800 font-bold w-1/5 flex items-center justify-center bg-amber-400 h-[37px] "> No Show - 0 </p>
                                        <p className="text-[17px] text-slate-800 font-bold w-1/5 flex items-center justify-center bg-blue-400 h-[37px] "> Cancelled - 0 </p>
                                        <p className="text-[17px] text-slate-800 font-bold w-1/5 flex items-center justify-center bg-red-400 h-[37px] "> Rescheduled - 0 </p>
                                    </span>
                                </div>
                            ...
                            <div className="w-[35%] h-full flex flex-col gap-3 pb-3">
                                <div className="h-full flex flex-col gap-3 justify-start w-full bg-white rounded-[5px]">
                                    <span className="flex flex-row items-center justify-start rounded-t-[5px] w-full bg-blue-200 h-[45px] border-2 border-blue-200 px-3">
                                        <p className="text-lg text-slate-600 font-semibold">PROBLEM LIST</p>
                                    </span>
                                    <div className="w-full flex items-center jusitify-center px-2 py-2">
                                        <span className="flex flex-row items-center justify-start w-full rounded-[3px] h-[40px] px-2">
                                            <p className="text-[15px] text-slate-600 font-bold"> </p>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="h-full flex flex-col gap-3 justify-start w-full bg-white rounded-[5px]">
                                    <span className="flex flex-row items-center justify-start rounded-t-[5px] w-full bg-blue-200 h-[45px] border-2 border-blue-200 px-3">
                                        <p className="text-lg text-slate-600 font-semibold">LAST CPT</p>
                                    </span>
                                    <div className="w-full flex items-center jusitify-center px-2 py-2">
                                        <span className="flex flex-row items-center justify-start w-full rounded-[3px] h-[40px] px-2">
                                            <p className="text-[16px] text-slate-500 font-semibold">PILLOW - PILLOWS</p>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="h-full flex flex-col gap-3 justify-start w-full bg-white rounded-[5px]">
                                    <span className="flex flex-row items-center justify-start rounded-t-[5px] w-full bg-blue-200 h-[45px] border-2 border-blue-200 px-3">
                                        <p className="text-lg text-slate-600 font-semibold">PATIENT GENERATED HEALTH DATA</p>
                                    </span>
                                    <div className="w-full flex items-center jusitify-center px-2 py-2">
                                        <span className="flex flex-row items-center justify-center w-full rounded-[3px] h-[40px] px-2">
                                            <p className="text-[15px] text-slate-500 ">No Patient Health Data Generated  </p>
                                        </span>
                                    </div>
                                </div>
                            </div>
